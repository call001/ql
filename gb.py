...
UA = "Mozilla/5.0 (Linux; Android 12; PDNM00 Build/RKQ1.211103.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/111.0.5563.116 Mobile Safari/537.36 XWEB/1110005 MMWEBSDK/20230805 MMWEBID/1737 MicroMessenger/8.0.42.2460(0x28002A58) WeChat/arm64 Weixin NetType/4G Language/zh_CN ABI/arm64" #抓包获取User-Agent(🔔必填)
key = "464b17b8943142a280d3acaa03c88fbb"  # (🔔必填) key参数为pushplus的token口令，或企业微信webhook机器人后面的 key，用于推送接收检测文章
                    ...
                    if "biz" in link:
                        ...
                        for message in messages:
                            ...
                            data = {
                                 "token": key,
                                 "title": "检测",
                                 "content": f'<body onload="window.location.href=\'{link}\'"></body>',
                                 "template": "html"
                            }
